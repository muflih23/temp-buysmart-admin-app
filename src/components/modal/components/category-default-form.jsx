...
function CategoryDefaultForm({options, sectionItems, sectionIndex, handleAddSectionItem, handleRemoveSectionItem, setItemIdx, itemIdx, disabled}) {
...
export default CategoryDefaultForm